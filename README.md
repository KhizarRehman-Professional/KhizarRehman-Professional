...
<sub><code> workflow (see Setup Instructions below) to generate this.
</div>
...
<sub><code> workflow manually from the Actions tab after pushing it.
</div>
...
<div align="center">
  ...
  <sub>💡 Use <a href="https://github.com/Readme-Workflows/recent-activity">recent-activity</a> GitHub Action to populate this automatically.</sub>
</div>
...
<h4>1. Snake Animation Workflow</h4>
Create <code>:
<pre>
name: Generate Snake
...
<h4>2. 3D Contribution Skyline Workflow</h4>
Create <code>:
<pre>
  ...
  build:
    ...
    steps:
      ...
      - name: Generate 3D Contrib
        ...
        env:
          GITHUB_TOKEN: ${{ secrets.GITHUB_TOKEN }}
          USERNAME: KhizarRehman-Professional

      - name: Push to Profile-3D-Contrib Branch
        uses: peaceiris/actions-gh-pages@v3
        with:
          github_token: ${{ secrets.GITHUB_TOKEN }}
